...
from electricity_price import CRF, fuel_costs, CO2_costs, electricity_prices, Bezugsgroessen
...
def test_electricity_prices():
    assert round(electricity_prices(1000000, 10, 1, 1, 50 , 50, 1.5 , 0.75, 15, 0.06, 3000),3) == 171.099
